...
$(document).ready(function(t){t("#slider1").sliderPro({width:800,height:290,arrows:!1,buttons:!1,waitForLayers:!0,thumbnailWidth:160,thumbnailHeight:330,thumbnailPointer:!0,autoplay:!1,autoScaleLayers:!1,breakpoints:{768:{thumbnailWidth:220,thumbnailHeight:150}}}),t("#slider2").sliderPro({width:1e3,height:400,arrows:!1,buttons:!1,waitForLayers:!0,thumbnailWidth:330,thumbnailHeight:230,thumbnailPointer:!0,autoplay:!1,autoScaleLayers:!1,breakpoints:{500:{thumbnailWidth:120,thumbnailHeight:50}}})}),$(document).ready(function(){$(".popup-with-form").magnificPopup({type:"inline",preloader:!1,focus:"#name",callbacks:{beforeOpen:function(){$(window).width()<700?this.st.focus=!1:this.st.focus="#name"}}})}),$(document).ready(function(){$("#test-form").submit(function(){var t=$(this);return $.ajax({type:"POST",url:"mail.php",data:t.serialize()}).done(function(){alert("Thank you!"),setTimeout(function(){t.trigger("reset")},1e3)}),!1})}),$(document).ready(function(){$("#test-form2").submit(function(){var t=$(this);return $.ajax({type:"POST",url:"mail.php",data:t.serialize()}).done(function(){alert("Thank you!"),setTimeout(function(){t.trigger("reset")},1e3)}),!1})}),$(document).ready(function(){$(".price-menu").on("click","a",function(t){t.preventDefault();var e=$(this).attr("href"),i=$(e).offset().top;$("body,html").animate({scrollTop:i},1500)})}),$(document).ready(function(){$(".mob-price").on("click","a",function(t){t.preventDefault();var e=$(this).attr("href"),i=$(e).offset().top;$("body,html").animate({scrollTop:i},1500)})});