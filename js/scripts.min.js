...
$(document).ready(function(t) {
    ...
    $("#test-form-vuz").submit(function() {
        ...
        return $.ajax({
            ...
            alert("Ваше сообщение отправлено! Скоро с Вами свяжутся!"), setTimeout(function() {
                t.trigger("reset")
            }, 1e3)
        }), !1
    })
}), $(document).ready(function() {
    $(".button-red").submit(function() {
        var t = $(this);

        $('mfp-ready').fadeOut('slow', function() {
    ...
    $(".price-menu").on("click", "a", function(t) {
        t.preventDefault();
    ...
    $(".mob-price").on("click", "a", function(t) {
        t.preventDefault();
        var e = $(this).attr("href"),
            i = $(e).offset().top;
        $("body,html").animate({
